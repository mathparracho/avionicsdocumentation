...
![img](../../../../static/img/docs/hardware/altium/drc/drc1.png)
...
![img](../../../../static/img/docs/hardware/altium/drc/drc2.png)
...
![img](../../../../static/img/docs/hardware/altium/drc/drc3.png)
...
![img](../../../../static/img/docs/hardware/altium/drc/drc4.png)
...
![img](../../../../static/img/docs/hardware/altium/drc/drc5.png)
...
![img](../../../../static/img/docs/hardware/altium/drc/drc6.png)
...
![img](../../../../static/img/docs/hardware/altium/drc/drc7.png)
...
![img](../../../../static/img/docs/hardware/altium/drc/drc8.png)
...
![img](../../../../static/img/docs/hardware/altium/drc/drc9.png)
*Gerando um relatório da categoria ‘Routing’, que contém nosso exemplo da trilha de 9V*

![img](../../../../static/img/docs/hardware/altium/drc/drc10.png)
...
![img](../../../../static/img/docs/hardware/altium/drc/drc13.png)
...
![img](../../../../static/img/docs/hardware/altium/drc/drc14.png)
...
![img](../../../../static/img/docs/hardware/altium/drc/drc15.png)
...
![img](../../../../static/img/docs/hardware/altium/drc/drc16.png)
...
![img](../../../../static/img/docs/hardware/altium/drc/drc17.png)

**SMD Pad to SMD Pad**:
- SMD Pad x SMD Pad: 0.127 mm

![img](../../../../static/img/docs/hardware/altium/drc/drc18.png)

**Minimum Spacing**:
- Track x Track: 0.2 mm

![img](../../../../static/img/docs/hardware/altium/drc/drc21.png)

### *Manufacturing » Silk To Solder Mask Clearance*
**Pad To Silkscreen**:
- Silkscreen To Object Minimum Clearance: 0.15 mm

![img](../../../../static/img/docs/hardware/altium/drc/drc19.png)

### *Manufacturing » Board Outline Clearance*
**Trace to Outline**:
- Minimum Clearance: 0.2 mm

![img](../../../../static/img/docs/hardware/altium/drc/drc20.png)

### *Mask » Solder Mask Expansion*
**Trace to Outline**:
- Expansion Top: 0.05 mm

![img](../../../../static/img/docs/hardware/altium/drc/drc22.png)
...
![img](../../../../static/img/docs/hardware/altium/drc/drc23.png)

Caso o aumento de temperatura seja de 10 ºC (normal para a maior parte das aplicações):

![img](../../../../static/img/docs/hardware/altium/drc/drc24.png)
